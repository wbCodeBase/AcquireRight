...
//         <div className="flex justify-center sm:gap-15  flex-wrap container mx-auto sm:max-w-7xl 11/12 w-full py-8 md:py-20">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-6 sm:gap-8 lg:gap-12">
            ...
            <div className="w-full lg:w-[52%] px-4 sm:px-6 lg:px-8">
              <div className="text-center lg:text-left">
                ...
                <h1 className="lg:text-4xl text-3xl my-2 font-lora text-ar-gray-700 fontmedium leading-tight">{heroSectionData.title}</h1>
